  ...
  return (
    <>
      <style>{`
        ...
        .progetto-card:hover { border-color: rgba(201,168,76,0.3); }
        .progetto-card-img {
          width: 100%;
          aspect-ratio: 16/9;
          overflow: hidden;
...
const progettiAttiviDefault = [
  {
    _id: '1',
    titolo: 'Concerto Degenerativo',
    sottotitolo: 'in solo · duo · trio · quartetto',
    descrizione: 'Il Concerto Degenerativo unisce musica strumentale, forma canzone e performance improvvisativa. Si declina in formazioni diverse adattandosi allo spazio e al contesto, mantenendo una ricerca continua tra scrittura e improvvisazione.',
    formazioni: ['Solo', 'Duo', 'Trio', 'Quartetto'],
  },
  {
    _id: '2',
    titolo: 'La Buona Novella',
    sottotitolo: "dall'opera di Fabrizio De André",
    descrizione: 'Con l\'Ensemble Laborintus e il coro della Polifonica Santa Cecilia di Sassari. Dal 2008 una produzione che attraversa i più importanti palchi della Sardegna, intrecciando musica, coro e narrazione poetica.',
  },
]

const progettiPassatiDefault = [
  { _id: '3', titolo: 'Figli di Iubal', sottotitolo: '2002 – 2014', descrizione: 'Primo grande progetto cantautorale. Due album pubblicati: Figli di Iubal (2003) e Un anno sull\'altipiano – Opera da due soldi (2006).' },
  { _id: '4', titolo: 'Carraioru Social Band', sottotitolo: 'World music · Festival Abbabula', descrizione: 'Omaggio alla canzone tradizionale sassarese reinterpretata con apporti stilistici eterogenei. Coproduzione con il Teatro Sassari.' },
  ...
  return (
    <>
      <style>{`
        ...
        .passato-item:hover { background: #0f0f0f; }
        .passato-titolo {
          font-family: 'Cormorant Garamond', serif;
          font-size: 1.2rem;
          color: #f5f2eb;
